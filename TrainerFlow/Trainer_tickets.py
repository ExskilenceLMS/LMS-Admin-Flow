...
def fetch_all_tickets(request):
    try:
        ...
        for student_id, issues in student_data.items():
            ...
            resolved_issues_list = [issue for issue in issues if issue.issue_status.lower() == 'resolved']
            ...
            result.append({
                ...
                "status_of_latest_issue": "Resolved" if latest_issue.issue_status.lower() == "resolved" else "Not Resolved",
